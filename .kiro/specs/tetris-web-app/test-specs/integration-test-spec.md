# Integration Test Specification: tetris-web-app integrationテスト
...
### 1.1 Purpose
tetris-web-appの複数コンポーネント間の連携が正常に動作することを確認する
...
### 1.2 Scope
tetris-web-appのシステムフロー（ゲーム開始フロー, テトリミノ移動・回転フロー（WebSocketリアルタイム）, ライン消去とスコア計算フロー, ゲームオーバーとスコア保存フロー）
...
- Test data fixtures: `tests/__fixtures__/tetris-web-app`
- Data cleanup script: ``
- External API mock data: `tests/__mocks__/tetris-web-app` (if applicable)
...
### Test Case IT-001: ゲーム開始フロー - 成功フロー

**Description**: ゲーム開始フローが正常に完了することを確認
...
### Test Case IT-002: ゲーム開始フロー - 失敗フロー
...
### Test Case IT-003: テトリミノ移動・回転フロー（WebSocketリアルタイム） - 成功フロー

**Description**: テトリミノ移動・回転フロー（WebSocketリアルタイム）が正常に完了することを確認
...
### Test Case IT-004: テトリミノ移動・回転フロー（WebSocketリアルタイム） - 失敗フロー
...
### Test Case IT-005: ライン消去とスコア計算フロー - 成功フロー

**Description**: ライン消去とスコア計算フローが正常に完了することを確認
...
### Test Case IT-006: ライン消去とスコア計算フロー - 失敗フロー
...
### Test Case IT-007: ゲームオーバーとスコア保存フロー - 成功フロー

**Description**: ゲームオーバーとスコア保存フローが正常に完了することを確認
...
### Test Case IT-008: ゲームオーバーとスコア保存フロー - 失敗フロー
