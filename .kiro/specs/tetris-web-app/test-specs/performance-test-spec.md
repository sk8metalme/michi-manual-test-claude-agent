# Performance Test Specification: tetris-web-app performanceテスト
...
### Test Case PERF-001: 応答時間テスト - 通常負荷
...
**Expected Results**:
- The テトリスアプリ shall ブロック移動・回転操作のレスポンスタイムを100ミリ秒以内とする
...
### Test Case PERF-002: スループットテスト - ピーク負荷
...
**Expected Results**:
- The テトリスアプリ shall 単体テストのコードカバレッジを80%以上とする
